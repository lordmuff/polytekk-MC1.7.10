...
public class PT_Combs extends MultiItemRandomWithCompat implements IItemRottable {
    ...
    public void addItems() {
        ...
        PT_ItemCont.Comb_Rad.set(addItem(1, "Rad Comb", ""));
        PT_ItemCont.Comb_Actinide.set(addItem(2, "Actinide Comb", ""));
        PT_ItemCont.Comb_Schrabidium.set(addItem(3, "Schrabidium Comb", ""));
        PT_ItemCont.Comb_Xen.set(addItem(4, "Extradimensional Comb", ""));
        PT_ItemCont.Comb_Limpid.set(addItem(5, "Limpid Comb", ""));
