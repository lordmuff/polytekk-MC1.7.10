...
public class PT_BlockCrystalOres_Hot extends BlockBaseMeta {

    public static OreDictMaterial[] ORE_MATERIALS = {MT.AncientDebris, MT.Firestone, PT_Loader_Materials.Volcanic, MT.Sunstone, MT.Blaze, MT.PhosphorusWhite, MT.PhosphorusRed};

    public PT_BlockCrystalOres_Hot(String aUnlocalised) {
        super(null, aUnlocalised, Material.glass, soundTypeGlass, ORE_MATERIALS.length, Textures.BlockIcons.CRYSTAL_ORES);
        LH.add(getUnlocalizedName()+ ".0", "Crystallized Ancient Debris");
        LH.add(getUnlocalizedName()+ ".1", "Firestone Crystal");
        LH.add(getUnlocalizedName()+ ".2", "Volcanic Crystal");
        LH.add(getUnlocalizedName()+ ".3", "Sunstone Crystal");
        LH.add(getUnlocalizedName()+ ".4", "Crystallized Blaze");
        LH.add(getUnlocalizedName()+ ".5", "Phosphorus Crystal (White)");
        LH.add(getUnlocalizedName()+ ".6", "Phosphorus Crystal (Red)");
