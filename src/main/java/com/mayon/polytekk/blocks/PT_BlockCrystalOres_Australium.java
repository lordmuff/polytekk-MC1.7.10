...
public class PT_BlockCrystalOres_Australium extends BlockBaseMeta {

    public static OreDictMaterial[] ORE_MATERIALS = {PT_Loader_Materials.Australium};

    public PT_BlockCrystalOres_Australium(String aUnlocalised) {
        super(null, aUnlocalised, Material.glass, soundTypeGlass, ORE_MATERIALS.length, Textures.BlockIcons.CRYSTAL_ORES);
        LH.add(getUnlocalizedName()+ ".0", "Australium Formation");
