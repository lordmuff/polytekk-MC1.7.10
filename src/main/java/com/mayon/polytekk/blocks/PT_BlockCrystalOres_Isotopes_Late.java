...
public class PT_BlockCrystalOres_Isotopes_Late extends BlockBaseMeta {

    public static OreDictMaterial[] ORE_MATERIALS = {PT_Loader_Materials.Cf_251, PT_Loader_Materials.Cf_252, PT_Loader_Materials.Bk_247, PT_Loader_Materials.Es_253};

    public PT_BlockCrystalOres_Isotopes_Late(String aUnlocalised) {
        super(null, aUnlocalised, Material.glass, soundTypeGlass, ORE_MATERIALS.length, Textures.BlockIcons.CRYSTAL_ORES);
        LH.add(getUnlocalizedName()+ ".0", "Californium-251 Formation");
        LH.add(getUnlocalizedName()+ ".1", "Californium-252 Formation");
        LH.add(getUnlocalizedName()+ ".2", "Berkelium-247 Formation");
        LH.add(getUnlocalizedName()+ ".3", "Einsteinium-253 Formation");
