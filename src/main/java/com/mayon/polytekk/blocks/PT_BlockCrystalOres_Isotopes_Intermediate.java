...
public class PT_BlockCrystalOres_Isotopes_Intermediate extends BlockBaseMeta {

    public static OreDictMaterial[] ORE_MATERIALS = {MT.Am_241, MT.Am_242, MT.Pu_239, MT.Pu_240, MT.Cm, MT.Po};

    public PT_BlockCrystalOres_Isotopes_Intermediate(String aUnlocalised) {
        super(null, aUnlocalised, Material.glass, soundTypeGlass, ORE_MATERIALS.length, Textures.BlockIcons.CRYSTAL_ORES);
        LH.add(getUnlocalizedName()+ ".0", "Americium-241 Formation");
        LH.add(getUnlocalizedName()+ ".1", "Americium-242 Formation");
        LH.add(getUnlocalizedName()+ ".2", "Plutonium-239 Formation");
        LH.add(getUnlocalizedName()+ ".3", "Plutonium-240 Formation");
        LH.add(getUnlocalizedName()+ ".4", "Crystalline Curium");
        LH.add(getUnlocalizedName()+ ".5", "Crystalline Polonium");
