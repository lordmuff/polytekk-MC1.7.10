...
public class PT_BlockCrystalOres_Precious extends BlockBaseMeta {

    public static OreDictMaterial[] ORE_MATERIALS = {MT.OREMATS.Sperrylite, MT.OREMATS.Cooperite, MT.OREMATS.Coltan, MT.OREMATS.Borax, MT.OREMATS.Mica, MT.Asbestos, MT.Eudialyte, MT.Craponite, MT.Diamond, MT.Emerald, MT.Ruby, MT.Peridot, MT.Sapphire};

    public PT_BlockCrystalOres_Precious(String aUnlocalised) {
        super(null, aUnlocalised, Material.glass, soundTypeGlass, ORE_MATERIALS.length, Textures.BlockIcons.CRYSTAL_ORES);
        LH.add(getUnlocalizedName()+ ".0", "Sperrylite Crystal");
        LH.add(getUnlocalizedName()+ ".1", "Cooperite Crystal");
        LH.add(getUnlocalizedName()+ ".2", "Coltan Crystal");
        LH.add(getUnlocalizedName()+ ".3", "Borax Crystal");
        LH.add(getUnlocalizedName()+ ".4", "Mica Crystal");
        LH.add(getUnlocalizedName()+ ".5", "Asbestos Crystal");
        LH.add(getUnlocalizedName()+ ".6", "Eudialyte Crystal");
        LH.add(getUnlocalizedName()+ ".7", "Craponite Crystal");
        LH.add(getUnlocalizedName()+ ".8", "Diamond Crystal");
        LH.add(getUnlocalizedName()+ ".9", "Emerald Crystal");
        LH.add(getUnlocalizedName()+".10", "Ruby Crystal");
        LH.add(getUnlocalizedName()+".11", "Peridot Crystal");
        LH.add(getUnlocalizedName()+".12", "Sapphire Crystal");
