...
public class PT_BlockCrystalOres_UltraPrecious extends BlockBaseMeta {

    public static OreDictMaterial[] ORE_MATERIALS = {MT.Adamantine, PT_Loader_Materials.Tiberium, MT.Ke, MT.Nq, MT.Ta, MT.Alexandrite};

    public PT_BlockCrystalOres_UltraPrecious(String aUnlocalised) {
        super(null, aUnlocalised, Material.glass, soundTypeGlass, ORE_MATERIALS.length, Textures.BlockIcons.CRYSTAL_ORES);
        LH.add(getUnlocalizedName()+ ".0", "Adamantine Crystal");
        LH.add(getUnlocalizedName()+ ".1", "Tiberium Crystal");
        LH.add(getUnlocalizedName()+ ".2", "Trinium Crystal");
        LH.add(getUnlocalizedName()+ ".3", "Naquadah Crystal");
        LH.add(getUnlocalizedName()+ ".4", "Tantalum Crystal");
        LH.add(getUnlocalizedName()+ ".5", "Alexandrite Crystal");
