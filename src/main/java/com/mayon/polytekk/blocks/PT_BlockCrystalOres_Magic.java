...
public class PT_BlockCrystalOres_Magic extends BlockBaseMeta {

    public static OreDictMaterial[] ORE_MATERIALS = {MT.InfusedAir, MT.InfusedEarth, MT.InfusedOrder, MT.InfusedEntropy, MT.InfusedFire, MT.InfusedWater, MT.InfusedBalance, MT.InfusedVis, MT.Amber, MT.Vinteum, MT.BlueTopaz, MT.Chimerite};

    public PT_BlockCrystalOres_Magic(String aUnlocalised) {
        super(null, aUnlocalised, Material.glass, soundTypeGlass, ORE_MATERIALS.length, Textures.BlockIcons.CRYSTAL_ORES);
        LH.add(getUnlocalizedName()+ ".0", "Infused Air Crystal");
        LH.add(getUnlocalizedName()+ ".1", "Infused Earth Crystal");
        LH.add(getUnlocalizedName()+ ".2", "Infused Order Crystal");
        LH.add(getUnlocalizedName()+ ".3", "Infused Entropy Crystal");
        LH.add(getUnlocalizedName()+ ".4", "Infused Fire Crystal");
        LH.add(getUnlocalizedName()+ ".5", "Infused Water Crystal");
        LH.add(getUnlocalizedName()+ ".6", "Infused Balance Crystal");
        LH.add(getUnlocalizedName()+ ".7", "Infused Vis Crystal");
        LH.add(getUnlocalizedName()+ ".8", "Amber Crystal");
        LH.add(getUnlocalizedName()+ ".9", "Vinteum Crystal");
        LH.add(getUnlocalizedName()+".10", "Blue Topaz Crystal");
        LH.add(getUnlocalizedName()+".11", "Chimerite Crystal");
