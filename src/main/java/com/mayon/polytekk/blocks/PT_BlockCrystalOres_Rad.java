...
public class PT_BlockCrystalOres_Rad extends BlockBaseMeta {

    public static OreDictMaterial[] ORE_MATERIALS = {MT.OREMATS.Uraninite, MT.Th, MT.OREMATS.Pitchblende};

    public PT_BlockCrystalOres_Rad(String aUnlocalised) {
        super(null, aUnlocalised, Material.glass, soundTypeGlass, ORE_MATERIALS.length, Textures.BlockIcons.CRYSTAL_ORES);
        LH.add(getUnlocalizedName()+ ".0", "Uraninite Crystal");
        LH.add(getUnlocalizedName()+ ".1", "Thorianite Crystal");
        LH.add(getUnlocalizedName()+ ".2", "Crystalline Pitchblende");
