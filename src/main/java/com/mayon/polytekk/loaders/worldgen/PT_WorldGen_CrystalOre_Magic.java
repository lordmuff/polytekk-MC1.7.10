...
public class PT_WorldGen_CrystalOre_Magic extends WorldgenObject {

    @SafeVarargs
    public PT_WorldGen_CrystalOre_Magic(String aName, boolean aDefault, List<WorldgenObject>... aLists) {
    ...
    public boolean generate(World aWorld, Chunk aChunk, int aDimType, int aMinX, int aMinZ, int aMaxX, int aMaxZ, Random aRandom, BiomeGenBase[][] aBiomes, Set<String> aBiomeNames) {
        ...
        int aX = aMinX+aRandom.nextInt(16), aY = WD.waterLevel(aWorld), aZ = aMinZ+aRandom.nextInt(16), aMeta = new NoiseGenerator(aWorld).get(aX/2, 360, aZ/2, PT_BlockCont.CrystalOresPT_Magic.maxMeta());
        ...
        aWorld.setBlock(aX, aY, aZ, PT_BlockCont.CrystalOresPT_Magic, aMeta, 2);
        for (int i = 0; i < 1500; ++i) {
            ...
            if (WD.air(aWorld, tX, tY, tZ)) {
                ...
                for (int tSide : ALL_SIDES_VALID) {
                    ...
                    if (block == PT_BlockCont.CrystalOresPT_Magic) tCount++;
                }
                if (tCount == 1) aWorld.setBlock(tX, tY, tZ, PT_BlockCont.CrystalOresPT_Magic, aMeta, 2);
            }
        }
        return T;
    }
