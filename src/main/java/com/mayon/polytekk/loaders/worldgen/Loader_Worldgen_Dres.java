...
public class Loader_Worldgen_Dres implements Runnable {
    ...
    public void run() {
        ...
        new WorldgenOresLarge("ore.large.tantalite"  , T, T, 1, 80,   33, 1, 6, MT.OREMATS.Coltan        , MT.OREMATS.Coltan      , MT.OREMATS.Columbite                       , MT.OREMATS.Tantalite         , GEN_DRES);
        new WorldgenOresLarge("ore.large.adamantine"  , T, T, 1, 45,   21, 6, 48, MT.OREMATS.BrownLimonite        , MT.OREMATS.YellowLimonite      , MT.Adamantine                       , MT.Adamantine         , GEN_DRES);
        new WorldgenOresLarge("ore.large.tengam"  , T, T, 1, 20,   13, 3, 28, MT.Nd        , MT.Nd      , PT_Loader_Materials.Tengam                       , MT.Sm         , GEN_DRES);
        new WorldgenOresLarge("ore.large.tiberium"  , T, T, 1, 45,   13, 13, 56, MT.Ruby        , MT.BlueSapphire      , MT.Alexandrite                       , PT_Loader_Materials.Tiberium         , GEN_DRES);
