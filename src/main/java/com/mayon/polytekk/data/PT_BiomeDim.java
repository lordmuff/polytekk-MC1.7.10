...
public class PT_BiomeDim {
    ...
    public static final int
        ...
        DIM_MOHO = SpaceConfig.mohoDimension


        , DIM_EVE = SpaceConfig.eveDimension


        , DIM_MUN = SpaceConfig.moonDimension


        , DIM_MINMUS = SpaceConfig.minmusDimension


        , DIM_DUNA = SpaceConfig.dunaDimension


        , DIM_DRES = SpaceConfig.dresDimension


        , DIM_IKE = SpaceConfig.ikeDimension


        , DIM_LAYTHE = SpaceConfig.laytheDimension


        , DIM_TEKTO = SpaceConfig.tektoDimension
